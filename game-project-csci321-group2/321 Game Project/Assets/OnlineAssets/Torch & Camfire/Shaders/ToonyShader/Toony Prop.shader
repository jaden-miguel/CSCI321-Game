	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				surfaceDescription.Color = ( _Dimming * ( ( tex2DNode111 * SampleGradient( gradient117, ( ( (dotResult98*0.26 + 0.5) * max( max( mainLight86 , 0.0 ) , 0.0 ) ) + max( max( break101.x , break101.y ) , break101.z ) ) ) ) + float4( temp_output_89_0 , 0.0 ) ) ).rgb;
				surfaceDescription.Emission = ( lerpResult109 * smoothstepResult114 * _RimColor * tex2DNode111 ).rgb;
...
/*ASEBEGIN
Version=19001
0;0;2560;1389;4347.955;1547.499;1.993412;True;False
...
Node;AmplifyShaderEditor.WireNode;153;-63.15305,1178.575;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;1;0;134;0
WireConnection;1;1;153;0
ASEEND*/
//CHKSM=8489BD07EE45958E6E90E27D420C4AB011F96133